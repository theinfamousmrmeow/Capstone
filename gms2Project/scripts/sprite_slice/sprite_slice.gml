/// @description sprite_divide(sprite,x1,y1,x2,y2)
/// @param sprite
/// @param x1
/// @param y1
/// @param x2
/// @param y2
function sprite_slice(argument0, argument1, argument2, argument3, argument4) {
	/*
	...
	*/
	...
	if surface_exists(script_surface_one)
	{
	     surface_set_target(script_surface_one)
	          ...
	          draw_sprite(script_sprite_one,-1,script_xoffset,script_yoffset)///draw sprite on surface

	          draw_set_blend_mode_ext(bm_zero,bm_inv_src_alpha)///causes black drawn lines to erase color
	...
	if surface_exists(script_surface_two)
	{
	     surface_set_target(script_surface_two)
	          ...
	          draw_sprite(script_sprite_two,-1,script_xoffset,script_yoffset)///draw sprite on surface
