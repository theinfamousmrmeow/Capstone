function initParticles() {
	...
	//Fire Particle
	global.p_explode = part_type_create();
	part_type_sprite(global.p_explode , spr_splode_large, 1, 1, 0);
	part_type_life(global.p_explode, 24, 32);

	//Fire Particle
	global.p_small_explode = part_type_create();
	part_type_sprite(global.p_small_explode , spr_splode_small, 1, 1, 0);
	part_type_life(global.p_small_explode, 20, 24);
	////POISON
	...
	//part_type_life(global.p_sparkle, 6,10);
	//part_type_color_mix(global.p_sparkle,c_white,c_yellow);
	...
	global.p_impact = part_type_create();

	part_type_sprite(global.p_impact , spr_fx_hit, 1, 1, 0);
	part_type_life(global.p_impact,8,8);
	...
	part_type_sprite(global.p_dust , spr_fx_dust, 1, 1, 0);
	...
	part_type_life(global.p_dust, 10, 15);
